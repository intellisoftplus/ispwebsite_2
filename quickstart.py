...
# at ~/.credentials/reseller-python-quickstart.json
SCOPES = 'https://www.googleapis.com/auth/apps.order'
CLIENT_SECRET_FILE = 'client_secret.json'
APPLICATION_NAME = 'Google Apps Reseller API Python Quickstart'
...
def main():
    ...
    Creates a Google Admin-SDK Reseller API service object and
